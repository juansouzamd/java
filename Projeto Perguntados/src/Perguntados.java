...
public class Perguntados {
    public static void main(String[] args) {
        ...
        Arrays.fill(vetorNumerosSorteados, -1);

        long inicioTempo = new Date().getTime();
        ...
        for (int rodada = 0; rodada < 25; rodada++) {
            ...
            fimVidas(vidas, pontuacao, classificacao, inicioTempo);

            ultimaRodada(rodada, contadorRespostasCertas, pontuacao, classificacao, inicioTempo);
    ...
    public static void fimVidas(int vidas, int pontuacao, String classificacao, long inicioTempo) {
        ...
        if (vidas == 0) {
            ...
            String time = calculaTempo(inicioTempo);
            System.out.println("O jogo durou " + time);
        }

    }

    public static void ultimaRodada(int rodada, int contadorRespostasCertas, int pontuacao, String classificacao, long inicioTempo) {
    ...
    public static String ranking(int pontuacao){
        ...
        } else if (pontuacao <= 210 && pontuacao > 150){
            resposta = "Nível Prata";
        } else if (pontuacao <= 290 && pontuacao > 210){
            resposta = "Nível Ouro";
  ...
  public static String calculaTempo(long inicio) {
        ...
        double tempoSeg = Math.round(tempoEmSeg);
        if(tempoSeg >= 60){
          double tempoMin = tempoSeg/60;
          return (Math.round(tempoMin) + " minutos.");
        } else {
          return (tempoSeg + " segundos.");
        }
    }
}