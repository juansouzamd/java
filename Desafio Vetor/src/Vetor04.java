...
class Vetor04 {
    public static void main(String[] args) {
        ...
        System.out.println("Vetor com maior sequência de números consecutivos:");
        ...
        if (vetorComQuebras[ultimoIndiceMaiorSequencia] == posicaoQuebras[0]) {
            ...
            for (int i = ultimoIndiceMaiorSequencia
                    - (tamanhoMaiorSequencia - 1); i <= ultimoIndiceMaiorSequencia; i++) {
                System.out.print((int) vetorComQuebras[i] + " ");
            }
        }
